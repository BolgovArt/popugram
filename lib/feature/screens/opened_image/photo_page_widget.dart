...
// ? а в чем разница. А как через final сделать то?
// PageController controller = PageController(); 
// late PageController controller;
// ниже выдает ошибку
// final PageController controller; 
// _PageState() : controller: PageController(); 
  ...
  final dynamicAppBarColorForTextSpan = Theme.of(context).appBarTheme.foregroundColor;
    return Scaffold(
        ...
        body: PageView.builder(
          ...
          itemCount: images2page.length,
          itemBuilder: (context, index) {

            final double _scale = currentIndex == index ? 1.0 : 0.87;
                ...
                child: Hero(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image:
                        DecorationImage(image: images2page[index], fit: BoxFit.cover),
                    ),
                  ),
                ),
              ),
