...
ResponseElements _$ResponseElementsFromJson(Map<String, dynamic> json) =>
    ResponseElements(
      ...
      sizes: (json['sizes'] as List<dynamic>)
          .map((e) => ResponseSize.fromJson(e as Map<String, dynamic>))
          .toList(),
    );
...
ResponseSize _$ResponseSizeFromJson(Map<String, dynamic> json) => ResponseSize(
      url: json['url'] as String,
    );

Map<String, dynamic> _$ResponseSizeToJson(ResponseSize instance) =>
    <String, dynamic>{
      'url': instance.url,
    };
